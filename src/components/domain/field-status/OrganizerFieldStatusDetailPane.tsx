  ...
  return (
    ...
    >
      ...
      <DetailSection
        step={1}
        title="현장 확인"
        hint={getFieldCheckInStepHint(row.checkInStatus)}
      >
        <FieldStatusCheckInActions row={row} hideTitle />
      </DetailSection>
      ...
      <section className="flex flex-col gap-2 rounded-lg border border-rose-200 bg-rose-50/40 p-3">
        <h3 className="text-sm font-bold text-rose-900">관리</h3>
