...
import { completeGymStaffPasswordResetAction } from "@/features/gym-staff-account/actions";

type FormStatus = "idle" | "submitting" | "success" | "error";

export function GymStaffPasswordResetForm({
  token,
  staffName,
  loginIdMasked,
}: {
  ...
  return (
    <form
      ...
      onSubmit={(e) => {
        ...
        void (async () => {
          try {
            const res = await completeGymStaffPasswordResetAction({
              token,
              password,
              passwordConfirm,
            });
    ...
    >
      ...
      <section className="space-y-3">
        ...
        <div className="space-y-1.5">
          <label
            htmlFor="gym-staff-reset-password"
        ...
        <div className="space-y-1.5">
          <label
            htmlFor="gym-staff-reset-password-confirm"
            className="block text-xs font-medium"
          >
            비밀번호 확인
          </label>
          <div className="flex gap-2">
            <input
              id="gym-staff-reset-password-confirm"
