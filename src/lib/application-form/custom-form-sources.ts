...
export const CUSTOM_FORM_SOURCE_OPTIONS: CustomFormSourceOption[] = [
  ...
  { value: "division.sportType", label: "부문 종목", group: "부문" },
  { value: "division.gender", label: "부문 성별", group: "부문" },
  { value: "division.ageGroup", label: "부문 연령대", group: "부문" },
  { value: "division.weightClass", label: "부문 체급", group: "부문" },
