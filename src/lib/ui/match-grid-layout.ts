...
/** 대진표 본문 — RED | 중앙 | BLUE 3열 (Desktop: fill panel, never force 220px overflow) */
export const bracketMatchFightersGridClass =
  "grid grid-cols-1 gap-2 px-3 py-2 md:grid-cols-[minmax(220px,1fr)_minmax(140px,170px)_minmax(220px,1fr)] md:items-stretch md:gap-x-2 desktop:grid-cols-[minmax(0,1fr)_minmax(140px,170px)_minmax(0,1fr)]";
